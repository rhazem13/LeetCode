...
<pre style="position: relative;"><strong>Input:</strong> queries = [3,1,2,1], m = 5
...
<pre style="position: relative;"><strong>Input:</strong> queries = [4,1,2,2], m = 4
<strong>Output:</strong> [3,1,2,0]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> queries = [7,5,5,8,3], m = 8
